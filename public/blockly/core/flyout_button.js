...
export class FlyoutButton {
     ...
     * @internal
     */
    constructor(workspace, targetWorkspace, json, isLabel_) {
        this.workspace = workspace;
        this.targetWorkspace = targetWorkspace;
        this.isLabel_ = isLabel_;
        /** Mouse up event data. */
    ...
    createDom() {
        ...
        this.svgGroup = dom.createSvgElement(Svg.G, { 'class': cssClass }, this.workspace.getCanvas());
        let shadow;
        if (!this.isLabel_) {
