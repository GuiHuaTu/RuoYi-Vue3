...
export class FieldMultilineInput extends FieldTextInput {
    ...
    initView() {
        ...
        this.textGroup = dom.createSvgElement(Svg.G, {
    ...
    render_() {
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            const span = dom.createSvgElement(Svg.TEXT, {
    ...
    updateSize_() {
        ...
        for (let i = 0; i < nodes.length; i++) {
            const tspan = nodes[i];
            const textWidth = dom.getFastTextWidth(tspan, fontSize, fontWeight, fontFamily);
...
`);
//# sourceMappingURL=field_multilineinput.js.map