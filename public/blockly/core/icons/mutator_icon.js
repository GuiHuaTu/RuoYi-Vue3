...
export class MutatorIcon extends Icon {
    ...
    setBubbleVisible(visible) {
        ...
        eventUtils.fire(new (eventUtils.get(eventUtils.BUBBLE_OPEN))(this.sourceBlock, visible, 'mutator'));
    }
    ...
    recomposeSourceBlock() {
        ...
        if (oldExtraState !== newExtraState) {
            eventUtils.fire(new (eventUtils.get(eventUtils.BLOCK_CHANGE))(this.sourceBlock, 'mutation', null, oldExtraState, newExtraState));
        }
    ...
    static reconnect(connectionChild, block, inputName) {
        deprecation.warn('MutatorIcon.reconnect', 'v10', 'v11', 'connection.reconnect');
        if (!connectionChild)
            return false;
    ...
    static findParentWs(workspace) {
        deprecation.warn('MutatorIcon.findParentWs', 'v10', 'v11', 'workspace.getRootWorkspace');
