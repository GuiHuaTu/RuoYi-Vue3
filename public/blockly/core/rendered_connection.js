...
export class RenderedConnection extends Connection {
    ...
    bumpAwayFrom(staticConnection) {
        ...
        let dx = staticConnection.x +
            config.snapRadius +
            Math.floor(Math.random() * BUMP_RANDOMNESS) -
            this.x;
        let dy = staticConnection.y +
            config.snapRadius +
            Math.floor(Math.random() * BUMP_RANDOMNESS) -
            this.y;
        if (reverse) {
    ...
    highlight() {
        ...
        if (this.type === ConnectionType.INPUT_VALUE ||
            ...
            const xLen = renderConstants.NOTCH_OFFSET_LEFT - renderConstants.CORNER_RADIUS;
        ...
        this.highlightPath = dom.createSvgElement(Svg.PATH, {
