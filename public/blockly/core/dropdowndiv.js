 ...
 * @returns True if the menu rendered below block; false if above.
 */
function showPositionedByRect(bBox, field, opt_onHide, opt_secondaryYOffset) {
    ...
    return show(field, sourceBlock.RTL, primaryX, primaryY, secondaryX, secondaryY, opt_onHide);
}
/**
 ...
 * @internal
 */
export function show(newOwner, rtl, primaryX, primaryY, secondaryX, secondaryY, opt_onHide) {
    owner = newOwner;
