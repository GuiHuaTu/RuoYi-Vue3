...
export class BlockFieldIntermediateChange extends BlockBase {
    ...
    constructor(opt_block, opt_name, opt_oldValue, opt_newValue) {
        super(opt_block);
        this.type = eventUtils.BLOCK_FIELD_INTERMEDIATE_CHANGE;
...
registry.register(registry.Type.EVENT, eventUtils.BLOCK_FIELD_INTERMEDIATE_CHANGE, BlockFieldIntermediateChange);
