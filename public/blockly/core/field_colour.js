...
export class FieldColour extends Field {
     ...
     */
    initView() {
        this.size_ = new Size(this.getConstants().FIELD_COLOUR_DEFAULT_WIDTH, this.getConstants().FIELD_COLOUR_DEFAULT_HEIGHT);
    ...
    dropdownCreate() {
        ...
        aria.setState(table, aria.State.ROWCOUNT, Math.floor(colours.length / columns));
        ...
        this.boundEvents.push(browserEvents.conditionalBind(table, 'pointerdown', this, this.onClick, true));
        this.boundEvents.push(browserEvents.conditionalBind(table, 'pointermove', this, this.onMouseMove, true));
        this.boundEvents.push(browserEvents.conditionalBind(table, 'pointerenter', this, this.onMouseEnter, true));
        this.boundEvents.push(browserEvents.conditionalBind(table, 'pointerleave', this, this.onMouseLeave, true));
        this.boundEvents.push(browserEvents.conditionalBind(table, 'keydown', this, this.onKeyDown, false));
        this.picker = table;
    }
...
FieldColour.COLOURS = [
    ...
    '#990000', '#660000', '#330000',
    '#ffcc99', '#ff9966', '#ff9900', '#ff6600',
    '#cc6600', '#993300', '#663300',
    '#ffff99', '#ffff66', '#ffcc66', '#ffcc33',
    '#cc9933', '#996633', '#663333',
    ...
    '#339999', '#336666', '#003333',
    '#ccffff', '#66ffff', '#33ccff', '#3366ff',
    '#3333ff', '#000099', '#000066',
    '#ccccff', '#9999ff', '#6666cc', '#6633ff',
    '#6600cc', '#333399', '#330099',
...
`);
//# sourceMappingURL=field_colour.js.map