...
export class Gesture {
    ...
    constructor(e, creatorWorkspace) {
        ...
        this.bubbleDragger = null;
        /** The object tracking a block drag, or null if none is in progress. */
        this.blockDragger = null;
        /**
    ...
    startDraggingBlock() {
        const BlockDraggerClass = registry.getClassFromOptions(registry.Type.BLOCK_DRAGGER, this.creatorWorkspace.options, true);
        this.blockDragger = new BlockDraggerClass(this.targetBlock, this.startWorkspace_);
    ...
    startDraggingBubble() {
        ...
        this.bubbleDragger = new BubbleDragger(this.startBubble, this.startWorkspace_);
    ...
    cancel() {
        ...
        Touch.longStop();
        if (this.bubbleDragger) {
            this.bubbleDragger.endBubbleDrag(this.mostRecentEvent, this.currentDragDeltaXY);
        }
        else if (this.blockDragger) {
    ...
    doBlockClick() {
        ...
        if (this.flyout && this.flyout.autoClose) {
            ...
            const event = new (eventUtils.get(eventUtils.CLICK))(this.startBlock, this.startWorkspace_.id, 'block');
