 ...
 */
export class FieldAngle extends FieldInput {
    /**
    ...
    constructor(value, validator, config) {
         ...
         */
        this.clockwise = FieldAngle.CLOCKWISE;
        /**
         * The offset of zero degrees (and all other angles).
         */
        this.offset = FieldAngle.OFFSET;
        /**
         * The maximum angle to allow before wrapping.
         */
        this.wrap = FieldAngle.WRAP;
        /**
         * The amount to round angles to when using a mouse or keyboard nav input.
         */
        this.round = FieldAngle.ROUND;
        /**
    ...
    showEditor_(e) {
        ...
        if (this.sourceBlock_ instanceof BlockSvg) {
            dropDownDiv.setColour(this.sourceBlock_.style.colourPrimary, this.sourceBlock_.style.colourTertiary);
        }
    ...
    dropdownCreate() {
        ...
        const circle = dom.createSvgElement(Svg.CIRCLE, {
            'cx': FieldAngle.HALF,
            'cy': FieldAngle.HALF,
            'r': FieldAngle.RADIUS,
            'class': 'blocklyAngleCircle',
        }, svg);
        this.gauge = dom.createSvgElement(Svg.PATH, { 'class': 'blocklyAngleGauge' }, svg);
        this.line = dom.createSvgElement(Svg.LINE, {
            'x1': FieldAngle.HALF,
            'y1': FieldAngle.HALF,
        ...
        this.boundEvents.push(browserEvents.conditionalBind(svg, 'click', this, this.hide));
        // On touch devices, the picker's value is only updated with a drag. Add
        // a click handler on the drag surface to update the value if the surface
        // is clicked.
        this.boundEvents.push(browserEvents.conditionalBind(circle, 'pointerdown', this, this.onMouseMove_, true));
        this.boundEvents.push(browserEvents.conditionalBind(circle, 'pointermove', this, this.onMouseMove_, true));
        return svg;
    }
    ...
    displayMouseOrKeyboardValue(angle) {
        ...
        if (angle !== this.value_) {
            ...
            if (this.sourceBlock_ &&
                ...
                eventUtils.fire(new (eventUtils.get(eventUtils.BLOCK_FIELD_INTERMEDIATE_CHANGE))(this.sourceBlock_, this.name || null, oldValue, this.value_));
            }
        }
    }
    ...
    updateGraph() {
        ...
        if (!isNaN(angleRadians)) {
            ...
            path.push(' l ', x1, ',', y1, ' A ', FieldAngle.RADIUS, ',', FieldAngle.RADIUS, ' 0 ', largeFlag, ' ', clockwiseFlag, ' ', x2, ',', y2, ' z');
        }
...
(function (Mode) {
    ...
    Mode["PROTRACTOR"] = "protractor";
})(Mode || (Mode = {}));
//# sourceMappingURL=field_angle.js.map