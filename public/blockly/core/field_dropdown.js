...
export class FieldDropdown extends Field {
    ...
    showEditor_(e) {
        ...
        if (this.selectedMenuItem) {
            ...
            style.scrollIntoContainerView(this.selectedMenuItem.getElement(), dropDownDiv.getContentDiv(), true);
        }
        this.applyColour();
    }
    ...
    renderSelectedImage(imageJson) {
        ...
        const height = Math.max(hasBorder ? this.getConstants().FIELD_DROPDOWN_BORDER_RECT_HEIGHT : 0, imageHeight + IMAGE_Y_PADDING);
        ...
        if (this.svgArrow) {
            ...
            arrowWidth = dom.getFastTextWidth(this.arrow, this.getConstants().FIELD_TEXT_FONTSIZE, this.getConstants().FIELD_TEXT_FONTWEIGHT, this.getConstants().FIELD_TEXT_FONTFAMILY);
        }
    ...
    renderSelectedText() {
        ...
        const textWidth = dom.getFastTextWidth(this.getTextElement(), this.getConstants().FIELD_TEXT_FONTSIZE, this.getConstants().FIELD_TEXT_FONTWEIGHT, this.getConstants().FIELD_TEXT_FONTFAMILY);
        const xPadding = hasBorder
            ? this.getConstants().FIELD_BORDER_RECT_X_PADDING
            : 0;
        let arrowWidth = 0;
