<template>
    <div class="app-container">
       <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
          ...
          <el-form-item label="PLC类型" prop="plcType">
             <el-input v-model="queryParams.plcType" placeholder="请输入PLC类型" clearable style="width: 240px"
                @keyup.enter="handleQuery" />
          </el-form-item>
       ...
       <el-dialog :title="title" v-model="open" width="500px" append-to-body>
          <el-form ref="plcRef" :model="form" :rules="rules" label-width="80px">
             <el-form-item label="PLC名称" prop="plcName">
                <el-input v-model="form.plcName" placeholder="请输入PLC名称" />
             </el-form-item>
             <el-form-item label="PLC类型" prop="plcType">
                <el-input v-model="form.plcType" placeholder="请输入PLC类型" />
             </el-form-item>
             <el-form-item label="状态" prop="status">
 ...
 import { listPlc, getPlc, delPlc, addPlc, updatePlc, refreshCache } from "@/api/plcManage/plc";
 ...
 const data = reactive({
    ...
    rules: {
       plcName: [{ required: true, message: "PLC名称不能为空", trigger: "blur" }],
